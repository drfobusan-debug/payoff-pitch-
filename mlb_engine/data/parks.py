...
PARKS: dict[int, Park] = {
    ...
    3: Park(3, "Fenway Park", 42.3467, -71.0972, 45.0, "open", 104.0, carry_factor=1.15),
    4: Park(4, "Rate Field", 41.8299, -87.6338, 130.0, "open", 101.0),
    5: Park(5, "Progressive Field", 41.4962, -81.6852, 0.0, "open", 98.0, wind_factor=0.6),
    7: Park(7, "Kauffman Stadium", 39.0517, -94.4803, 45.0, "open", 100.0, carry_factor=0.82),
    ...
    17: Park(17, "Wrigley Field", 41.9484, -87.6553, 30.0, "open", 103.0, wind_factor=1.20, carry_factor=1.05),
    19: Park(19, "Coors Field", 39.7559, -104.9942, 0.0, "open", 112.0, wind_factor=1.05, carry_factor=1.08),
    ...
    2394: Park(2394, "Comerica Park", 42.339, -83.0485, 150.0, "open", 98.0, wind_factor=0.95, carry_factor=0.85),
    2395: Park(2395, "Oracle Park", 37.7786, -122.3893, 90.0, "open", 96.0, wind_factor=0.35, carry_factor=0.90),
    2529: Park(2529, "Sutter Health Park", 38.5802, -121.5135, 45.0, "open", 100.0),
    2602: Park(2602, "Great American Ball Park", 39.0975, -84.5069, 30.0, "open", 104.0, wind_factor=1.05, carry_factor=1.12),
    2680: Park(2680, "Petco Park", 32.7073, -117.157, 0.0, "open", 95.0, carry_factor=0.90),
    2681: Park(2681, "Citizens Bank Park", 39.9061, -75.1665, 15.0, "open", 103.0, wind_factor=1.10, carry_factor=1.10),
    2889: Park(2889, "Busch Stadium", 38.6226, -90.1928, 60.0, "open", 98.0),
    3289: Park(3289, "Citi Field", 40.7571, -73.8458, 25.0, "open", 97.0, carry_factor=0.95),
    3309: Park(3309, "Nationals Park", 38.873, -77.0074, 30.0, "open", 100.0),
    3312: Park(3312, "Target Field", 44.9817, -93.2776, 90.0, "open", 100.0),
    3313: Park(3313, "Yankee Stadium", 40.8296, -73.9262, 75.0, "open", 102.0, carry_factor=1.10),
