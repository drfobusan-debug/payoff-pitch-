...
CANDIDATE_SCREENS: tuple[CandidateScreen, ...] = (
    ...
    # Shipped, so no longer graded here: the fade side of the conviction ceiling
    # reached 544 graded buys at -6.3%, negative in both halves, and is now the
    # live ``batter_under_prob_ceiling`` gate. Its record continues under
    # :func:`screen_probation`, which can lift it if the refusals start paying.
)
